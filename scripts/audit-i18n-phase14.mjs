...
const compatibilityTranslationFiles = [
  ...
  "client/src/i18n/phase3RemainingTranslations.part27.ts",
  ...
  "client/src/i18n/backendMessagesPhase7Translations.part12.ts",
  ...
  "client/src/i18n/factoryStockEntryTranslations.ts",
