...
export const applicationEnglishTranslations = {
  ...
  "mobileNav.more": "More",
  "mobileNav.allPages": "All pages",
  "mobileNav.allPagesDescription": "Every page you can open, grouped by area.",
  "mobileNav.findPage": "Find a page",
  "mobileNav.noPages": "No pages match your search.",
  "mobileRecords.actions": "Actions",
  "mobileRecords.showDetails": "More details",
  "mobileRecords.hideDetails": "Fewer details",
  "mobileRecords.back": "Back",
