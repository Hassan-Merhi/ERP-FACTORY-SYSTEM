...
export const retailWave1Translations: readonly Phase3SharedUiEntry[] = [
  ...
  { en: "Leave empty for Other / No Brand", ar: "اتركه فارغًا لاختيار أخرى / بدون علامة", fr: "Laissez vide pour Autre / Sans marque" },
  { en: "One image URL per line (up to 8)", ar: "رابط صورة واحد في كل سطر (حتى 8)", fr: "Une URL d’image par ligne (jusqu’à 8)" },
  { en: "Search product, code or brand…", ar: "ابحث عن منتج أو رمز أو علامة…", fr: "Rechercher un produit, un code ou une marque…" },
  ...
  { en: "Other / No Brand or custom brand", ar: "أخرى / بدون علامة أو علامة مخصصة", fr: "Autre / Sans marque ou marque personnalisée" },
  ...
  { en: "Each size has its own barcode, price, cost and location stock.", ar: "لكل مقاس باركود وسعر وتكلفة ومخزون مواقع مستقل.", fr: "Chaque taille possède son propre code-barres, prix, coût et stock par emplacement." },
  ...
  { en: "Retail inventory is only available when a Retail / Variant Inventory company is selected.", ar: "يتوفر مخزون التجزئة فقط عند اختيار شركة من نوع مخزون التجزئة / المتغيرات.", fr: "Le stock de détail est disponible uniquement lorsqu’une société Stock détail / variantes est sélectionnée." },
  ...
  { en: "Products grouped by brand with independent stock and barcodes for every size.", ar: "منتجات مجمعة حسب العلامة مع مخزون وباركود مستقلين لكل مقاس.", fr: "Produits regroupés par marque avec un stock et un code-barres indépendants pour chaque taille." },
  ...
  { en: "No products match these filters.", ar: "لا توجد منتجات تطابق عوامل التصفية.", fr: "Aucun produit ne correspond à ces filtres." },
  ...
  { en: "Product code and name are required", ar: "رمز المنتج واسمه مطلوبان", fr: "Le code et le nom du produit sont requis" },
  { en: "Every variant needs a size and barcode", ar: "كل متغير يحتاج إلى مقاس وباركود", fr: "Chaque variante doit avoir une taille et un code-barres" },
  { en: "Choose a populated Excel file first", ar: "اختر أولًا ملف Excel يحتوي على بيانات", fr: "Choisissez d’abord un fichier Excel contenant des données" },
  {
  ...
  { en: "Retail inventory is only available for Retail / Variant Inventory companies", ar: "مخزون التجزئة متاح فقط لشركات مخزون التجزئة / المتغيرات", fr: "Le stock de détail est disponible uniquement pour les sociétés Stock détail / variantes" },
  ...
  { en: "Import is limited to 5,000 rows per file", ar: "الاستيراد محدود بـ 5,000 صف لكل ملف", fr: "L’importation est limitée à 5 000 lignes par fichier" },
  { en: "Brand not found for this company", ar: "لم يتم العثور على العلامة لهذه الشركة", fr: "Marque introuvable pour cette société" },
  {
  ...
  { en: "Variant does not belong to this product", ar: "المتغير لا ينتمي إلى هذا المنتج", fr: "La variante n’appartient pas à ce produit" },
  {
