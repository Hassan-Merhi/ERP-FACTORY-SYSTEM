...
const factoryStaffTrackingTranslations = {
  ...
  defaultTargetsSaved: {
    en: "Fixed category and target saved",
    ar: "تم حفظ الفئة والهدف الثابت",
  ...
  useEditorToManageTargets: {
    en: "Fixed Target repeats category and target forward; Edit Targets changes only the selected day.",
    ar: "الهدف الثابت يكرر الفئة والهدف للأيام القادمة، بينما تعديل الأهداف يغيّر اليوم المحدد فقط.",
    fr: "L’objectif fixe répète la catégorie et l’objectif à l’avenir ; Modifier les objectifs ne change que le jour sélectionné.",
  },
  ...
  totalAbsent: { en: "Total Absent", ar: "إجمالي الغائبين", fr: "Total absents" },
  totalPresent: { en: "Total Present", ar: "إجمالي الحاضرين", fr: "Total présents" },
