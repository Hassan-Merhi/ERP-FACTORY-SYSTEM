...
import type { AdjustmentFormData } from "./VoucherEditSchemas";
...
export function AdjustmentEditForm({
  ...
  form: UseFormReturn<AdjustmentFormData>;
  voucher: VoucherData;
            ...
            <div className="md:hidden space-y-3">
                ...
                return (
                  <div key={field.id} className="border rounded-md p-3 space-y-3">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t">
                      ...
                      <span className="font-mono font-medium" data-testid={`text-total-adj-mobile-${index}`}>
              ...
              <div className="flex items-center justify-between gap-2 pt-2">
                <Button
                  ...
                  data-testid="button-add-row-adj-mobile"
                >
