...
import {
  FACTORY_SETTINGS_TABS,
  FACTORY_TAB_GROUPS as FACTORY_ACCESS_TAB_GROUPS,
} from "@/app/factoryTabAccessRegistry";
...
export const FACTORY_TABS = FACTORY_SETTINGS_TABS;
export const FACTORY_TAB_GROUPS = FACTORY_ACCESS_TAB_GROUPS;
