...
export function PageHeader({
  ...
  //    actions column shrinks to what the title leaves (12rem, or half a narrow header) and its
  ...
  return (
    <header
      ref={headerRef}
      className="mb-3 grid min-w-0 grid-cols-[auto_minmax(0,1fr)] items-start gap-x-1 gap-y-2 border-b border-border pb-3 sm:mb-5 sm:grid-cols-[minmax(min(12rem,50%),1fr)_minmax(0,max-content)] sm:gap-x-4 sm:gap-y-3 sm:pb-4"
      data-testid="page-header"
