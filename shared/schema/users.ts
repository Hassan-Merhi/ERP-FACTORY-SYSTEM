...
export const userLocationCashAccounts = pgTable(
...
export const userPreferences = pgTable("user_preferences", {
  ...
  productionOverviewValuationMode: text("production_overview_valuation_mode").notNull().default("cost"),
...
export const insertUserPreferencesSchema = createInsertSchema(userPreferences)
  ...
  .extend({
    ...
    productionOverviewValuationMode: z.enum(["cost", "selling"]).default("cost"),
  });
