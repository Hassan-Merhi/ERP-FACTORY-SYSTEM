/**
 * Shared canonical Factory page-access registry.
 *
 * This file is UI-framework agnostic. Settings, navigation, route guards and
 * backend authorization consume this same registry so Factory access cannot drift.
 */
